...
import 'package:flutter_hotelpage/companents/travelCard.dart';
                            ...
                            child: TabBarView(
                              ...
                              Container(
                                  child:ListView(
                                    ...
                                    children: [
                                      travelCard(
                                        urls[0],"Sheraton","Bishkek",5),
                                        travelCard(
                                        urls[1],"Novotel","Bishkek",4),
                                        travelCard(
                                        urls[2],"Hayat Regency","Bishkek",3),
                                        travelCard(
                                          urls[3],"Jannat resort","Bishkek",3)
                                    ],
                                ),
                              ),
                              Container(
                                  child:ListView(
                                    ...
                                    children: [
                                       travelCard(
                                        urls[3],"Jannat resort","Bishkek",3),
                                        travelCard(
                                        urls[2],"Hayat Regenct","Bishkek",4),
                                        travelCard(
                                        urls[1],"Novotel","Bishkek",5),
                                        travelCard(
                                          urls[0],"Sheraton","Bishkek",5)
                                    ],
                                ),
